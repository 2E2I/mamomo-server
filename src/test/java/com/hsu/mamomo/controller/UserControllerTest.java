    ...
    public void getUserInfoTest() throws Exception {
        MvcResult mvcResult = mockMvc
                ...
                .andDo(document("get-user-info-with-jwtToken",
                        ...
                        requestHeaders(
                                headerWithName(HttpHeaders.AUTHORIZATION).description("api/user/authenticate 로 발급받은 조회할 유저의 토큰.\n"
                        ...
                        responseFields(
                                ...
                                fieldWithPath("create_date").ignored(),
                                fieldWithPath("modify_date").ignored(),
