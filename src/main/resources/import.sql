...
INSERT INTO user (id, birth, email, nickname, password, sex) value ('testId','2000-01-01','test@email.com','testNickName','{bcrypt}$2a$10$GXbyN.DHQXq1gWKKsVu7DeQ6Gc4kE8QeFb..RpOHHYw00sRQRkNha','M');
